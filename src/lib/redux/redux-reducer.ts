...
import alert, { IAlertReduxState } from '../../components/alert/Widgets';
import auth, { IAuthReduxState } from '../../components/auth/Widgets';
import menu, {
  IStateFromProps as IVerticalMenuReduxState,
} from '../../components/menu/vertical/Widgets';
import tab, { ITabReduxState } from '../../components/grid-layout-tab/Widgets';
/**
